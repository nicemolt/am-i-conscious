...
MODELS = [
    ...
    ("anthropic/claude-opus-5", "Claude Opus 5", "claude", "standard", "claude-opus-5", None),
    ("anthropic/claude-opus-5-fast", "Claude Opus 5 (Fast)", "claude", "standard", "claude-opus-5", None),
    # Claude Fable
    ("anthropic/claude-fable-5", "Claude Fable 5", "claude", "standard", "claude-fable-5", None),
