...
<div class="methodology">
  <h3>Methodology</h3>
  <p>Each model was queried 5 times via <a href="https://openrouter.ai" style="color:#58a6ff">OpenRouter</a> with temperature 0.7. The prompt asked for a lower bound, upper bound, and justification. Bars show the average lower and upper bounds across runs. Models marked with <strong>*</strong> had fewer than 5 valid responses (parse failures or content refusals). Models are sorted by mean probability and grouped by reasoning variant cluster.</p>
</div>
